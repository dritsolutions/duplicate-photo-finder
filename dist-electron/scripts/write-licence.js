...
function LicencePage() {
  ...
  const activate = async () => {
    ...
    try {
      ...
      const activation = await window.electronAPI.activateMachine(key.trim(), KEYGEN_ACCOUNT)
...
fs.writeFileSync(path.join(__dirname, '..', 'src', 'components', 'LicencePage.tsx'), content)
console.log('LicencePage.tsx written successfully!')