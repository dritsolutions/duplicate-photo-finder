...
electron.contextBridge.exposeInMainWorld("electronAPI", {
  ...
  organisePhotos: (sourceFolder, destFolder, mode, includeSubfolders) => electron.ipcRenderer.invoke("photos:organise", sourceFolder, destFolder, mode, includeSubfolders),
  onOrganiseProgress: (callback) => electron.ipcRenderer.on("organise:progress", (_event, data) => callback(data)),
  removeOrganiseProgressListener: () => electron.ipcRenderer.removeAllListeners("organise:progress")
});
